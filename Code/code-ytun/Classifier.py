...
##            np.savetxt(allDir+'/time_'+classifierFileName, np.array([ elapsed_time]), fmt='%f')
    ...
    def predict(self,tweet,diry,featFileName,classifierFileName):
...
def main():
    ...
    #Run the experiment
    c=Classifier(classifierType=classifierType,ngramType=ngramType) 
   ...
   # print "train_set:",train_set 
    ...
    c.predict_many(test_set, test_gold,raw_test_set,train_time,allDir,testresultFileName,reportFileName)

    
##global word_feat           
##word_feat= pickle.load(open('model/'+featFileName+'.pickle', 'rb'))
